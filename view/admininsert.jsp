...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ pageContext.request.contextPath }/css/admininsert.css" />
	...
	$(function(){
		...
		$("#tj").click(function(){
			...
			if(id.trim()==""||name.trim()==""||price==""||!price.match(regexPrice)||price<=0){
				$(".infocontent").css("color","#721c24");
				$(".infocontent").css("background-color","#f8d7da");
				$(".infocontent").css("border-color","#f5c6cb");
			...
			var url=$pageContext+"/admininsert";
					...
					<div class="tab-content">
							...
							<div class="alert alert-dismissible infocontent p-0 m-0"> <!-- alert-danger在js实现 -->
								...
								<div class="input-group mt-1 pt-1">
									<span><b>编号</b></span>
									<input type="text" class="form-control ml-1 pl-1" name="id" autofocus="autofocus"  autocomplete="off" />
								</div>					

								<div class="input-group mt-1 pt-1">
									<span><b>名称</b></span>
									<input type="text" class="form-control ml-1 pl-1" name="name" autocomplete="off" />
								</div>
								<div class="input-group mt-1 pt-1">
									<span><b>类别</b></span>
									<select id="selctg" name="category" class="ml-2 clearfix">
									...
									<!-- 销量 -->
									<input type="hidden" class="form-control ml-1 pl-1" name="pnum" value="0" autocomplete="off" />
				
								<div class="input-group mt-1 pt-1">
									<span><b>现价</b></span>
									<input type="text" class="form-control ml-1 pl-1" name="price" autocomplete="off" />
								</div>
								<div class="input-group mt-1 pt-1">
									<span><b>描述</b></span>
									<input type="text" class="form-control ml-1 pl-1" name="description" autocomplete="off" />
								</div>
								
								<div class="input-group-lg mt-1 pt-1 clearfix w-100 text-center">
									<input type="button" class="btn m-1" value="添加图片" onclick="addfile()" />
									<img id="newimg" src="${ pageContext.request.contextPath }${sessionScope.imgurl}" alt="" class="adedit_img clearfix p-1 m-1" style="width:100px;height:100px" />
								</div> 
								<div>
									<input type="button" id="tj" class="btn btn-primary form-control pt-1" value="提交"/>
								</div>
								<a href="${ pageContext.request.contextPath }/adminorder/showorder">返回</a>
